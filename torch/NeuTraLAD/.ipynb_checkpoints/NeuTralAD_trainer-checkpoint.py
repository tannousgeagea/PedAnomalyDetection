...
class NeutralAD_trainer:
    ...
    def detect_outliers(self, loader,cls):
        ...
        return auc, f1, ap, loss_in.item() / (target_all == 0).sum(), loss_out.item() / (target_all == 1).sum(),score_all,target_all
    ...
    def train(self, train_loader,cls = None,max_epochs=100, optimizer=None, scheduler=None,
        ...
        return val_loss, val_auc, test_auc, test_ap,test_f1,score,target, best_score